...
GO
CREATE VIEW [Training].[Vw_TrainingExperience]
AS
SELECT        dbo.Experience_Criteria.Training_Id, dbo.Experience_Criteria.Exp_Id, dbo.Experience_Criteria.Exp_months, dbo.Experience_Criteria.Job_Title, dbo.Experience_Criteria.Status, dbo.Experience_Criteria.TStamp, 
                         dbo.Experience_Criteria.TOwner, dbo.Experience_Criteria.Mandatory, dbo.Experience_Criteria.Id, dbo.Experience.Company_Name, dbo.Experience.Industry_Field_Name, dbo.Training.Training_Name
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'Training', 'VIEW', N'Vw_TrainingExperience'
GO

EXEC sys.sp_addextendedproperty N'MS_DiagramPaneCount', 1, 'SCHEMA', N'Training', 'VIEW', N'Vw_TrainingExperience'
GO