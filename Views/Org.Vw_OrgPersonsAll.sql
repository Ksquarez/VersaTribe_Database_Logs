...
GO
CREATE VIEW [Org].[Vw_OrgPersonsAll]
AS
...
FROM            dbo.OrgPerson INNER JOIN
                         ...
                         dbo.Org ON dbo.Org.Org_Id = dbo.OrgPerson.Org_Id LEFT OUTER JOIN
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'Org', 'VIEW', N'Vw_OrgPersonsAll'
GO

EXEC sys.sp_addextendedproperty N'MS_DiagramPaneCount', 1, 'SCHEMA', N'Org', 'VIEW', N'Vw_OrgPersonsAll'
GO