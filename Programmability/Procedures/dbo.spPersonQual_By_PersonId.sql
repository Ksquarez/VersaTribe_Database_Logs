...
GO
CREATE PROCEDURE [dbo].[spPersonQual_By_PersonId]
(
	@Person_Id int
)
AS
Begin Try
	SET NOCOUNT ON;
	SELECT        PersonQualification.PQ_Id, Person.FirstName, Person.LastName,Course.Cou_Id, Course.Cou_Name, CourseType.Ctyp_Name, Institutes.Inst_Name, PersonQualification.YOP, PersonQualification.Grade,Institutes.City,
